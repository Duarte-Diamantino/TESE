...
set_target_properties(OsqpEigen::OsqpEigen PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libOsqpEigen.so.0.10.0"
  IMPORTED_SONAME_RELEASE "libOsqpEigen.so.0.10.0"
  )

list(APPEND _IMPORT_CHECK_TARGETS OsqpEigen::OsqpEigen )
list(APPEND _IMPORT_CHECK_FILES_FOR_OsqpEigen::OsqpEigen "${_IMPORT_PREFIX}/lib/libOsqpEigen.so.0.10.0" )
